...
#define CRTP_RX_TASK_STACKSIZE        2*(2* configMINIMAL_STACK_SIZE)
...
#define EXTRX_TASK_STACKSIZE          3*configMINIMAL_STACK_SIZE
...
#define FLOW_TASK_STACKSIZE           2*(2 * configMINIMAL_STACK_SIZE)
